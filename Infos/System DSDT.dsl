 ...
 *
 * Disassembly of iASLIyApUP.aml, Wed Sep 25 17:47:14 2024
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000071A1 (29089)
 *     Revision         0x02
 *     Checksum         0xA0
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xDB476000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xDB47A000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xDCBF8A18)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    If ((CNSB == One))
    {
        Scope (_SB.PCI0.GPP0)
        {
            ...
            PowerResource (P0NV, 0x00, 0x0000)
            {
                ...
                {
                    TPST (0x60AA)
                    Return (D0NV) /* \_SB_.PCI0.GPP0.P0NV.D0NV */
                }
                ...
                Method (_OFF, 0, NotSerialized)  // _OFF: Power Off
                {
                    ...
                    If (CondRefOf (\_SB.PCI0.GPP0._ADR))
                    {
                        ...
                        ADDR = _ADR /* \_SB_.PCI0.GPP0._ADR */
                        Local0 = M019 (Zero, DEVC, FUNC, 0x18)
